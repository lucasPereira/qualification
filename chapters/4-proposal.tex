...
A Figura~\ref{figure:lccss-lcs-comparison} ilustra a diferença entre as duas métricas por meio de dois testes sobre um pedido. As sequências de comandos são $\alpha=\langle A,B,C,D,E\rangle$ e $\beta=\langle A,B,X,D,Y\rangle$. Os comandos $A$ e $B$ criam o pedido e adicionam o primeiro item; $C$ aplica um desconto; $X$ adiciona outro item; $D$ confirma o pedido; e $E$ e $Y$ verificam os respectivos totais. A LCS contém $A$, $B$ e $D$, pois admite o comando comum posterior à divergência, e atribui grau 0,60. A LCCSS contém somente o prefixo $\langle A,B\rangle$ e atribui grau 0,40.
